      ...
      <div className="grid w-full max-w-[1280px] items-center gap-10 md:grid-cols-[736px_464px] md:gap-10">
        ...
        <section className="w-full md:w-[464px]">
          <div className="flex flex-col gap-5">
            ...
            <h1 className="pb-5 text-[42px] leading-[1.1] font-medium text-black">Esqueceu a senha</h1>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex h-6 items-center gap-1 rounded-[4px] bg-[#155BCB] px-2 text-white">
                ...
                <span className="text-[14px] leading-none">Email para receber um código de acesso</span>
              </div>
            </div>

            <Link href="/codigo-recuperacao" className="mt-2 flex h-[39px] items-center justify-center rounded-[20px] bg-[#1351B4] text-[16.8px] leading-none font-semibold text-white">
              Continuar
            </Link>
