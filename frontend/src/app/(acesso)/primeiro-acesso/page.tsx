      ...
      <div className="grid w-full max-w-[1280px] items-center gap-10 md:grid-cols-[736px_464px] md:gap-10">
        ...
        <section className="w-full md:w-[464px]">
          <div className="flex flex-col gap-5">
            ...
            <h1 className="pb-5 text-[29.03px] leading-[1.1] font-medium text-black">Primeiro acesso</h1>

            <div className="flex flex-col gap-2">
              <label className="text-[14px] leading-none font-semibold text-black">Email</label>
              <div className="flex h-10 items-center gap-2 rounded-[4px] border border-[#888888] bg-[#FCFCFC] pl-4 pr-1">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex h-10 items-center gap-2 rounded-[4px] border border-[#155BCB] bg-[#FCFCFC] pl-4 pr-1">
              ...
              <div className="flex h-6 items-center gap-1 rounded-[4px] bg-[#155BCB] px-2 text-white">
                ...
                <span className="text-[14px] leading-none">Solicite o código ao seu orientador ou coordenador do curso</span>
              </div>
            </div>

            <Link href="/cadastro" className="mt-2 flex h-[39px] items-center justify-center rounded-[20px] bg-[#1351B4] text-[16.8px] leading-none font-semibold text-white">
              Continuar
            </Link>
