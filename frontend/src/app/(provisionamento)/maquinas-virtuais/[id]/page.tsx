...
export default function MaquinaVirtualDetalhePage() {
  return (
    <div className="min-h-screen bg-[#F8F8F8]">
      ...
      <main className="w-full px-10 pt-0 pb-8">
        ...
        <section className="h-[137px] bg-white px-3 pt-2 shadow-[0_3px_6px_0_rgba(51,51,51,0.16)]">
          ...
          <p className="mt-[10px] text-[11.67px] leading-[16px] font-bold tracking-[1.5px] text-[rgba(0,0,0,0.87)] uppercase">NOME: MÁQUINA DE TESTE</p>
        ...
        <section className="mt-5 h-[157px] bg-white px-3 pt-2 shadow-[0_3px_6px_0_rgba(51,51,51,0.16)]">
          ...
          <p className="mt-[10px] text-[11.67px] leading-[16px] font-bold tracking-[1.5px] text-[rgba(0,0,0,0.87)] uppercase">SISTEMA OPERACIONAL: WINDOWS</p>
          <p className="mt-2 text-[11.67px] leading-[16px] font-bold tracking-[1.5px] text-[rgba(0,0,0,0.87)] uppercase">QUANTIDADE DE NÚCLEOS (CPUS): 2</p>
          <p className="mt-2 text-[11.67px] leading-[16px] font-bold tracking-[1.5px] text-[rgba(0,0,0,0.87)] uppercase">QUANTIDADE DE MEMÓRIA: 4 GB</p>
          <p className="mt-2 text-[11.67px] leading-[16px] font-bold tracking-[1.5px] text-[rgba(0,0,0,0.87)] uppercase">QUANTIDADE DE ARMAZENAMENTO: 64 GB</p>
        ...
        <section className="mt-5 h-[114px]">
          <p className="text-center text-[11.67px] leading-[16px] font-bold tracking-[1.5px] text-[#E52207]">ESTADO DA MÁQUINA</p>
          ...
          <div className="flex h-[39px] items-center justify-between border-b border-[#CCCCCC] px-4">
            <span className="text-[14px] leading-none text-[#1351B4]">MÁQUINA LIGADA</span>
            <span className="h-7 w-7 rounded-full bg-[#1FA433]" />
          </div>

          <div className="flex h-[39px] items-center justify-between px-4">
            <span className="text-[14px] leading-none text-[#1351B4]">MÁQUINA DESLIGADA</span>
        ...
        <div className="flex h-[71px] items-center justify-center gap-2 py-4">
          <Link
            ...
            className="flex h-[39px] w-[230px] items-center justify-center rounded-[20px] border border-[#B21D38] text-[16.8px] leading-none font-semibold text-[#B21D38]"
          >
            Excluir Máquina Virtual
          </Link>
          <Link
            href="/maquinas-virtuais/maquina-de-teste/utilizar"
            className="flex h-[39px] w-[225px] items-center justify-center rounded-[20px] bg-[#1351B4] text-[16.8px] leading-none font-semibold text-white"
          >
